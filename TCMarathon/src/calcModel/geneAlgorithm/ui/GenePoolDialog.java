...
public class GenePoolDialog extends JDialog implements ActionListener,
	...
	public GenePoolDialog(Frame aFrame, String aWord/* , DialogDemo parent */) {
		...
		String msgString1 = "���]�w���]���T�� (Setting Gene Pool)\n";
		String msgString2 = "���s�j�p (Pool size)";
		String msgString3 = "���t���v (probability Of Crossover)";
		String msgString4 = "���t���v (ratio Of Crossover)";
		String msgString5 = "�������v (probability Of Mutation)";
		String msgString6 = "�������v (ratio Of Mutation)";
		String msgString7 = "���N���� (number Of offspring)";
		String msgStringComment = "(���U Enter ���A���J���� genePool.txt �����n�����T�A\n�p�G���s�b�h�b���|�W�[�����A���B�N���n�����G�x�s)";
